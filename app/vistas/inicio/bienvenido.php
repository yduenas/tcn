...
<body>
	<div id="container">
		...
		<div id="body">
			<p><strong><?= FRAMEWORK_NAME ;?> PHP </strong>  genera dinámicamente la página que está viendo.</p>

			<p>Si desea editar esta página, la encontrará en::</p>
			<code>app/vistas/bienvenido.php</code>

			<p>El controlador correspondiente para esta página se encuentra en:</p>
			<code>app/controladores/inicios.php</code>

			<p>Si está explorando <strong>Complement PHP FRAMEWORK</strong>  por primera vez, debe comenzar leyendo la Guía del usuario . <a href="<?= RUTA_URL ?>guias/index">Guía del usuario</a>.</p>
		</div>
