...
$queryEmpresa = "SELECT 
	...
	CONVERT(DATE,TM_POSTULANTE_EMPR.FE_INGR_EMPR) AS FE_INGR_EMPR,
	T_AFPS.DE_AFPS,
	T_VIAS.CO_TIPO_VIAS, 
    T_VIAS.DE_TIPO_VIAS,
	...
	REPRE_UNI,
	VDIRECTORIO_RENOVACION.NO_APEL_PATE+' '+VDIRECTORIO_RENOVACION.NO_APEL_MATE+' '+VDIRECTORIO_RENOVACION.NO_TRAB AS JEFEE_LIDER,
...
LEFT JOIN HEADCOUNT.DBO.VDIRECTORIO_RENOVACION ON VDIRECTORIO_RENOVACION.CO_TRAB=TM_POSTULANTE_EMPR.RESP_PRA
	AND VDIRECTORIO_RENOVACION.TI_SITU='ACT'
...
while($registroEmpresa=odbc_fetch_array($resultEmpresa)) {
	...
	$JEFEE_LIDER=utf8_encode($registroEmpresa["JEFEE_LIDER"]);
...
<page backtop="15mm" backbottom="15mm" backleft="17mm" backright="15mm" style="font-size: 12pt; font-family: arial" >
	<table cellspacing="0" style="width: 100%;">
        <tr>
			...
			<td style="width: 80%; color: #444444;">
                <span style="color: black;font-size:17px;font-weight:bold;text-decoration: underline black;">CONVENIO DE PRÁCTICAS PREPROFESIONALES</span>
            </td>
    ...
    <table cellspacing="0" style="width: 100%; text-align: justify;  vertical-align: middle" >
        <tr>
		    ...
		    <td>
           		<span style="line-height:20px;font-size:13px;">Conste por el presente documento que se firma por triplicado, el Convenio de Aprendizaje con Predominio en la Empresa, celebrado de conformidad con el Artículo 11º y siguientes, de la Ley sobre Modalidades Formativas Laborales, Ley Nº 28518, y su Reglamento, aprobado mediante el Decreto Supremo N° 007-2005-TR, que se celebra entre LA EMPRESA, EL CENTRO DE FORMACIÓN PROFESIONAL y EL(LA) PRACTICANTE, identificados en este documento, de acuerdo a los términos y condiciones siguientes:</span>
           	</td>
    ...
    <table cellspacing="0" style="width: 100%; text-align: justify;  vertical-align: middle" >
        <tr>
		    <td style="width: 35%;">
           	...
           	<td style="width: 65%;">
           		<span style="line-height:30px;font-size:11px;">: <?php echo $nombre_universidad_postu ?></span>
           	</td>
        ...
        <tr>
		    <td style="width: 35%;">
           	...
           	<td style="width: 55%;">
           		<span style="l65e-height:20px;font-size:11px;">: <?php echo $ruc_universidad_postu ?></span>
           	</td>
        ...
        <tr>
		    <td style="width: 35%;">
           	...
           	<td style="width: 65%;">
           		<span style="line-height:30px;font-size:11px;">: <?php echo $direccion_universidad_postu ?></span>
           	</td>
        ...
        <tr>
		    <td style="width: 35%;">
           	...
           	<td style="width: 65%;">
           		<span style="line-height:30px;font-size:11px;">: <?php echo $representante_universidad_postu ?></span>
           	</td>
        ...
        <tr>
		    <td style="width: 35%;">
           	...
           	<td style="width: 65%;">
           		<span style="line-height:30px;font-size:11px;">: DNI - <?php echo $dni_representante_universidad_postu ?></span>
           	</td>
    ...
    <table cellspacing="0" style="width: 100%; text-align: justify;  vertical-align: middle" >
        <tr>
		    ...
		    <td>
           		<span style="font-weight:bold;font-size:12px;">C. EL PRACTICANTE</span>
           	</td>
    ...
    <table cellspacing="0" style="width: 100%; text-align: justify;  vertical-align: middle" >
        <tr>
		    <td style="width: 35%;">
           		<span style="line-height:30px;font-size:11px;">SITUACIÓN DEL PRACTICANTE</span>
           	</td>
           	<td style="width: 65%;">
    ...
    <table cellspacing="0" style="width: 100%; text-align: justify;  vertical-align: middle" >
        <tr>
		    <td style="width: 35%;">
           		<span style="line-height:30px;font-size:11px;">CENTRO DE FORMACIÓN</span>
           	</td>
           	<td style="width: 65%;">
           		<span style="line-height:30px;font-size:11px;">: ESTUDIANTE</span>
           	</td>
    ...
    <table cellspacing="0" style="width: 100%; text-align: justify;  vertical-align: middle" >
        <tr>
		    <td style="width: 35%;">
           	...
           	<td style="width: 65%;">
           		<span style="line-height:30px;font-size:11px;">: Lunes a Viernes</span>
           	</td>
    ...
    <table cellspacing="0" style="width: 100%; text-align: justify;  vertical-align: middle" >
        <tr>
		    <td style="width: 35%;">
           	...
           	<td style="width: 65%;">
           		<span style="line-height:30px;font-size:11px;">  de 9:00 am a 13:00 pm </span>
           	</td>
    ...
    <table cellspacing="0" style="width: 100%; text-align: justify;  vertical-align: middle" >
        <tr>
		    <td style="width: 35%;">
           	...
           	<td style="width: 65%;">
           		<span style="line-height:30px;font-size:11px;">  de 14:00 pm a 16:00 pm</span>
           	</td>
    ...
    <table cellspacing="0" style="width: 100%; text-align: justify;  vertical-align: middle" >
        <tr>
		    <td style="width: 35%;">
           		<span style="line-height:30px;font-size:11px;">ALMUERZO</span>
           	</td>
           	<td style="width: 65%;">
           		<span style="line-height:30px;font-size:11px;">: de 13:0 pm a 14:00 pm</span>
           	</td>
...
<page backtop="15mm" backbottom="15mm" backleft="17mm" backright="15mm" style="font-size: 12pt; font-family: arial" >
    ...
    <table cellspacing="0" style="width: 100%; text-align: justify;  vertical-align: middle" >
        <tr>
		    ...
		    <td>
           		<span style="line-height:15px;font-size:11.5px;">EL (LA) PRACTICANTE manifiesta su interés y necesidad de efectuar su Práctica Pre Profesional, durante su condición de estudiante para aplicar sus conocimientos, habilidades y aptitudes, mediante el desempeño en una situación real de trabajo. Por su parte, LA EMPRESA acepta colaborar, tanto con el indicado CENTRO DE FORMACIÓN PROFESIONAL como con EL (LA) PRACTICANTE en su tarea formativa.</span>
           	</td>
    ...
    <table cellspacing="0" style="width: 100%; text-align: justify;  vertical-align: middle" >
        <tr>
		    ...
		    <td>
           		<span style="line-height:15px;font-size:11.5px;">EL (LA) PRACTICANTE desempeñará las actividades formativas de <?php echo $puesto_postu ?> en el área de <?php echo $area_postu ?> en el domicilio de la empresa ubicado en, <?php echo $direccion_tienda_postu ?> de acuerdo a los datos generales señalados en el literal d)</span>
           	</td>
    ...
    <table cellspacing="0" style="width: 100%; text-align: justify;  vertical-align: middle" >
        <tr>
		    ...
		    <td>
				...
				<br>1) Brindar orientación y capacitación técnica y profesional a EL (LA) PRACTICANTE, dentro de su área de formación académica, así como evaluar sus prácticas.
				<br>2) Designar a un supervisor para impartir la orientación correspondiente a EL (LA) PRACTICANTE y para verificar el
				desarrollo y cumplimiento del Plan de Específico de Aprendizaje.
				<br>3) Emitir los informes que requiera el CENTRO DE FORMACIÓN PROFESIONAL, en relación con las actividades de EL (LA) PRACTICANTE.
				<br>4) No cobrar suma alguna por la formación otorgada.
				<br>5) Pagar puntualmente EL (LA) PRACTICANTE una subvención mensual convenida.
				<br>6) Otorgar EL (LA) PRACTICANTE una subvención adicional equivalente a media subvención económica mensual cada seis
				meses de duración continua de las prácticas.
				<br>7) Otorgar un descanso de quince (15) días debidamente subvencionados cuando la duración de las prácticas sea superior a doce (12) meses, teniendo en cuenta la acumulación de los periodos intermitentes que hubiera realizado EL (LA)
				PRACTICANTE.
				<br>8) Cubrir los riesgos de enfermedad y accidentes de EL (LA) PRACTICANTE, a través de un seguro privado con una cobertura equivalente a catorce (14) subvenciones mensuales en caso de enfermedad y treinta (30) por accidente.
				<br>9) Expedir la certificación de Prácticas Pre-Profesionales correspondiente</span>
           	</td>
    ...
    <table cellspacing="0" style="width: 100%; text-align: justify;  vertical-align: middle" >
        <tr>
		    ...
		    <td>
           		<span style="line-height:15px;font-size:11.5px;">Para efectos del presente convenio EL (LA) PRACTICANTE, se obliga a:
				<br>1) Suscribir un convenio de Práctica con LA EMPRESA acatando las disposiciones formativas que se le asignen.
				<br>2) Desarrollar sus Prácticas Pre-profesionales con disciplina y responsabilidad.
    ...
    <table cellspacing="0" style="width: 100%; text-align: justify;  vertical-align: middle" >
        <tr>
		    ...
		    <td>
				...
				<br>1) Planificar y desarrollar los programas formativos que respondan a las necesidades del mercado laboral con participación del sector
				productivo.
				<br>2) Dirigir y conducir las actividades de formación de EL (LA) PRACTICANTE en coordinación con LA EMPRESA.
				<br>3) Supervisar, evaluar y certificar las actividades formativas.
				<br>4) Coordinar con la empresa el mecanismo de monitoreo y supervisión de las actividades que desarrolla el practicante.</span>
           	</td>
    ...
    <table cellspacing="0" style="width: 100%; text-align: justify;  vertical-align: middle" >
        <tr>
		    ...
		    <td>
           		<span style="line-height:15px;font-size:11.5px;">LA EMPRESA ha contratado el seguro de Salud MAPFRE para cubrir los riesgos de enfermedad y accidentes de EL (LA) PRACTICANTE.</span>
           	</td>
...
<page backtop="15mm" backbottom="15mm" backleft="17mm" backright="15mm" style="font-size: 12pt; font-family: arial" >
    ...
    <table cellspacing="0" style="width: 100%; text-align: justify;  vertical-align: middle" >
        <tr>
        	<td>&nbsp;&nbsp;</td>
		    <td>
           		<span style="line-height:15px;font-size:11.5px;">a) El cambio de horario de clases de EL (LA) PRACTICANTE que dificulte el cumplimiento de las 30 Horas semanales de capacitación. <br>b) Por acuerdo entre EL (LA) PRACTICANTE, LA EMPRESA, EL CENTRO DE FORMACIÓN PROFESIONAL <br>Son causas de suspensión del convenio:
				<br>a) La enfermedad y el accidente comprobados, sin perjuicio de lo establecido en el numeral 8) de la cláusula tercera del presente convenio.
    ...
    <table cellspacing="0" style="width: 100%; text-align: justify;  vertical-align: middle" >
        <tr>
		    ...
		    <td>
				...
				<br>f) El incumplimiento de cualquiera de las obligaciones por parte de EL (LA) PRACTICANTE y específicamente las
				contempladas en la cláusula cuarta del presente convenio.
				<br>g) El incumplimiento de cualquiera de las obligaciones por parte del CENTRO DE FORMACIÓN PROFESIONAL, específicamente
				las contempladas en la cláusula quinta del presente convenio.
				<br>h) Por renuncia o retiro voluntario por parte de EL (LA) PRACTICANTE, mediante aviso a LA EMPRESA con antelación de diez (10) días hábiles</span>
           	</td>
    ...
    <table cellspacing="0" style="width: 100%; text-align: justify;  vertical-align: middle" >
        <tr>
		    ...
		    <td>
           		<span style="line-height:15px;font-size:11.5px;">EL (LA) PRACTICANTE declara conocer la naturaleza del presente convenio, el cual no tiene carácter laboral, de tal modo que sólo genera para las partes, los derechos y obligaciones específicamente previsto en el mismo y en el texto de la Ley N° 28518 y el Decreto Supremo N° 007-2005-TR.</span>
           	</td>
	...
	<table cellspacing="0" style="width: 100%; text-align: right;  vertical-align: middle" >
        <tr>
			...
			<td style="width: 40%; color: black;font-size:9px;text-align:middle;font-weight:bold;">
				<span>________________________________________</span>
            </td>
			<td style="width: 30%; color: black;font-size:9px;text-align:middle;font-weight:bold;">
	...
	<table cellspacing="0" style="width: 100%; text-align: right;  vertical-align: middle" >
        <tr>
			...
			<td style="width: 40%; color: black;font-size:9px;text-align:middle;font-weight:bold;">
				<span>REPRESENTANTE DEL CENTRO DE FORMACION PROFESIONAL</span>
            </td>
			<td style="width: 30%; color: black;font-size:9px;text-align:middle;font-weight:bold;">				
			</td>
...
<page backtop="15mm" backbottom="15mm" backleft="17mm" backright="15mm" style="font-size: 12pt; font-family: arial" >
	...
	<table cellspacing="0" style="width: 100%; text-align: justify;  vertical-align: middle" >
        <tr>
		    ...
		    <td style="width: 90%;">
           		<span style="font-size:12px;"> Plan Específico de Aprendizaje con predominio en el Centro de Formación Profesional: Prácticas Pre Profesionales.</span>
           	</td>
	...
	<table cellspacing="0" style="width: 100%; text-align: left;  vertical-align: middle">
		<tr>
			<td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000;width: 100%;font-size:12px;height: 13px"><?php echo $JEFEE_LIDER ?></td>
		</tr>
	</table>
	<br>
	<table cellspacing="0" style="width: 100%; text-align: justify;  vertical-align: middle" >
	...
	<table cellspacing="0" style="width: 100%; text-align: center;  vertical-align: middle">
		<tr>
			...
			<td style="border-top: 1px solid #000000; border-bottom: 0px solid #000000; border-left: 0px solid #000000; border-right: 1px solid #000000;width: 65%;font-size:12px;">5 días a la semana (Lunes a Viernes) en el horario de 9:00 am a 4:00 pm (La empresa otorgará al Beneficiario 01 hora de refrigerio)</td>
		</tr>
	</table>
	<table cellspacing="0" style="width: 100%; text-align: center;  vertical-align: middle">
		<tr>
