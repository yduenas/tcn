...
<page backtop="15mm" backbottom="15mm" backleft="15mm" backright="15mm" style="font-size: 12pt; font-family: arial" >
	...
	<table cellspacing="0" style="width: 100%; " id="color1">
        <tr>
            ...
            <td style="width: 75%; color: white;font-size:13px;text-align:center">
                <span style="color: white;font-size:20px;font-weight:bold">Resultados  Evaluación BSC <?php echo $peri ?>C <?php echo $anno ?></span>
            </td>
    ...
    $arregloEmp = $DAvTM_BSC_CUAT->ListarBSC_CuatriFiltro($vTM_BSC_CUAT,$peri,$anno);

    foreach($arregloEmp as $Item){

    	$des_area=trim($Item['DE_AREA']);
    	$anno=utf8_encode(trim($Item['NU_ANNO']));
    	if(trim($Item['NU_PERI_CUAT'])==1){
    		$peri_eva='1er.';
    	}elseif(trim($Item['NU_PERI_CUAT'])==2){
    		$peri_eva='2do.';
    	}elseif(trim($Item['NU_PERI_CUAT'])==3){
    		$peri_eva='3er.';
    	}

    	$peri_des=$peri_eva.' Cuatrimestre '.$anno;
  
    	if(trim($Item['NU_PERI_CUAT'])==1){
    		$peri_fec='ene-'.$anno.' a abr-'.$anno;
    	}elseif(trim($Item['NU_PERI_CUAT'])==2){
    		$peri_fec='may-'.$anno.' a ago-'.$anno;
    	}elseif(trim($Item['NU_PERI_CUAT'])==3){
    		$peri_fec='sep-'.$anno.' a dic-'.$anno;
    	}

    	
    	$real='S/. '.number_format(trim($Item['VENT_CUAT']), 2, ".", ",");  
    	$ppto='S/. '.number_format(trim($Item['CUOT_CUAT']), 2, ".", ",");  
    	$vs=round((trim($Item['VAR_ALC_VEN_CUAT']))*100,2).'%';
    	...
    	$obj_util_pe=number_format((trim($Item['PROM_CLUSTER_ALC_UTOP_CUAT']))*100, 2, ".", " ").'%';
    	$real_util_ope='S/. '.trim($Item['UTOP_CUAT']);  
    	$ppto_util_ope='S/. '.trim($Item['UTOP_PPTo']);  
    	$vs_util_ope=number_format((trim($Item['VAR_ALC_CLUSTER_ALC_UTOP_CUAT']))*100, 2, ".", " ").'%';
    	...
    	$real_inven='S/. '.trim($Item['INVE_CUAT']);  
    	$ppto_inven='S/. '.number_format(trim($Item['PPTo_INVE_CUAT']), 2, ".", ",");  
    	$vs_inven=number_format((trim($Item['VAR_ALC_INVE_CUAT']))*100, 2, ".", " ").'%';
    	...
    	$real_merma='S/. '.trim($Item['MERM_CUAT']);  
    	$ppto_merma='S/. '.number_format(trim($Item['PPTo_MERM_CUAT']), 2, ".", ",");  
    	$vs_merma=number_format((trim($Item['VAR_ALC_MERM_CUAT']))*100, 2, ".", " ").'%';
    	...
    	$real_clima=number_format((trim($Item['PROM_CLIMA_CUAT']))*100, 2, ".", " ").'%';
    	$ppto_clima='';  
    	$vs_clima='';
    	...
    	$real_indi_ser=number_format((trim($Item['PROM_MSHOP_CUAT']))*100, 2, ".", " ").'%';
    	...
    	$real_ao_ventas=number_format((trim($Item['PROM_AUD_VENT_CUAT']))*100, 2, ".", " ").'%';
    	...
    	$real_ao_almacen=number_format((trim($Item['PROM_AUD_ALM_CUAT']))*100, 2, ".", " ").'%';
    	...
    	$real_rotacion=number_format((trim($Item['ROT7_CUAT']))*100, 2, ".", " ").'%';
...
<table style="width: 100%;  text-align: center; font-size: 9.43pt; vertical-align: middle; padding-top: 7px" cellspacing="0">
       	...
       	<tr>
            <th rowspan="2" style="width: 80px ;color: white; height: 2%; padding-left: 5px; background: #808080; text-align: center;border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000">Periodo</th>
        ...
        <tr>
            <td style=" height: 2%; padding-left: 5px;  text-align: center;border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 0px solid #000000; "><?php echo $peri_fec ?></td>
		...
		<table cellspacing="0" style="width: 100%; text-align: center; font-size: 12pt; vertical-align: middle;" >
	        ...
	        <tr>
	           ...
	           <?php if (trim($Item['VAR_ALC_VEN_CUAT'])<0){ ?>
           ...
           <?php } ?>
	        ...
	        <tr>
              ...
              <td style=" color: black; height: 2%; padding-left: 5px; text-align: right;border-top: 0px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 0px solid #000000;color:red" ><?php echo $real_util_ope ?></td>
	           ...
	           <td style=" color: black; height: 2%; padding-left: 5px; text-align: right;border-top: 0px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 0px solid #000000" ><?php echo $ppto_util_ope ?></td>
                ...
                <?php if (trim($Item['VAR_ALC_CLUSTER_ALC_UTOP_CUAT'])<0){ ?>
	        ...
	        <tr>
	           ...
	           <td style=" color: black; height: 2%; padding-left: 5px; text-align: right;border-top: 0px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 0px solid #000000" ><?php echo $ppto_inven ?></td>
	            <?php if (trim($Item['VAR_ALC_INVE_CUAT'])<0){ ?>
	        ...
	        <tr>
              ...
              <td style=" color: black; height: 2%; padding-left: 5px; text-align: right;border-top: 0px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 0px solid #000000;color:red" ><?php echo $real_merma ?></td>
	           ...
	           <td style=" color: black; height: 2%; padding-left: 5px; text-align: right;border-top: 0px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 0px solid #000000" ><?php echo $ppto_merma ?></td>
	            <?php if (trim($Item['VAR_ALC_MERM_CUAT'])<0){ ?>
	        ...
	        <tr>
               ...
               <?php  
               $arregloEmp = $DAvTM_BSC_CUAT->ListarBSC_CuatriEOIndice($vTM_BSC_CUAT,$anno);
               ...
               <?php if (trim($Item['PROM_MSHOP_CUAT'])<0){ ?>
	        ...
	        <tr>
	           ...
	           <td style=" color: black; height: 2%; padding-left: 5px; background: #F2F2F2;text-align: right;border-top: 0px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 0px solid #000000" ><?php echo $EO_ventas ?>%</td>
                ...
                <?php if (trim($Item['PROM_AUD_VENT_CUAT'])<0){ ?>
	        ...
	        <tr>
               ...
               <?php  
               $arregloEmp = $DAvTM_BSC_CUAT->ListarBSC_CuatriEOAlmacen($vTM_BSC_CUAT,$anno);
               ...
               <?php if (trim($Item['PROM_AUD_ALM_CUAT'])<0){ ?>
	        ...
	        <tr>
               ...
               $arregloEmp = $DAvTM_BSC_CUAT->ListarBSC_CuatriEORotacionMayor($vTM_BSC_CUAT,$anno);

                    foreach($arregloEmp as $Item){
                        $EO_Rotacion_M=round($Item['EO'],0);
                    }

                    $arregloEmp = $DAvTM_BSC_CUAT->ListarBSC_CuatriEORotacionMenor($vTM_BSC_CUAT,$anno);
	        ...
	        <tr>
               ...
               <?php  
               $arregloEmp = $DAvTM_BSC_CUAT->ListarBSC_CuatriEOClima($vTM_BSC_CUAT,$anno);
	           ...
	           <?php if (trim($Item['PROM_CLIMA_CUAT'])<0){ ?>
