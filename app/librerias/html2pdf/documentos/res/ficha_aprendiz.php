...
while($registroEmpresa=odbc_fetch_array($resultEmpresa)) {
	...
	$tipo_contrato_postu=($registroEmpresa["CO_TIPO_CONT"]);
	if ($tipo_contrato_postu=='FLJ') {
		$dias_convenio='210 DÍAS';
	}elseif ($tipo_contrato_postu=='FJP') {
		$dias_convenio='120 DÍAS';
	}
	...
	if ($genero_postu=='FEMENINO') {
		...
		$ginecologico_postu='';
		$observacion_ginecologico_postu='';
		$patologia_ginecologica_postu='';
		$observacion_patologia_ginecologica_postu='';
	}
...
<page backtop="60mm" backbottom="15mm" backleft="17mm" backright="15mm" style="font-size: 12pt; font-family: arial" >
    ...
    <table cellspacing="0" style="width: 100%; text-align: justify;  vertical-align: middle" >
        <tr>
		    ...
		    <td>
           		<span style="line-height:25px;font-size:12px;">Yo, <?php echo $nom_postu ?>. Identificado con <?php echo $tipo_documento ?> Nro. <?php echo $dni_postulante ?>, postulante para el puesto <?php echo $especialidad_convenio ?>. Para la empresa <?php echo $des_emp ?>.</span>
           	</td>
...
<page backtop="15mm" backbottom="15mm" backleft="17mm" backright="15mm" style="font-size: 12pt; font-family: arial" >
	<table cellspacing="0" style="width: 100%;">
        <tr>
			...
			<td style="width: 80%; color: #444444;">
                <span style="color: black;font-size:17px;font-weight:bold;text-decoration: underline black;  ">CONVENIO DE APRENDIZAJE CON PREDOMINIO EN LA EMPRESA</span>
            </td>
    ...
    <table cellspacing="0" style="width: 100%; text-align: justify;  vertical-align: middle" >
        <tr>
		    ...
		    <td>
           		<span style="line-height:20px;font-size:13px;">Conste por el presente documento que se firma por triplicado, el Convenio de Aprendizaje con Predominio en la Empresa, celebrado de conformidad con el Artículo 11º y siguientes, de la Ley sobre Modalidades Formativas Laborales, Ley Nº 28518, y su Reglamento, aprobado mediante el Decreto Supremo N° 007-2005-TR, que se celebra entre LA EMPRESA, EL CENTRO DE FORMACIÓN PROFESIONAL y EL APRENDIZ, identificados en este documento, de acuerdo a los términos y condiciones siguientes:</span>
           	</td>
    ...
    <table cellspacing="0" style="width: 100%; text-align: justify;  vertical-align: middle" >
        <tr>
		    ...
		    <td>
           		<span style="font-weight:bold;font-size:12px;">B. EL CENTRO DE FORMACIÓN PROFESIONAL</span>
           	</td>
    ...
    <table cellspacing="0" style="width: 100%; text-align: justify;  vertical-align: middle" >
        <tr>
		    <td style="width: 35%;">
           	...
           	<td style="width: 65%;">
           		<span style="line-height:30px;font-size:11px;">: CETPRO Privado Tecnología Centralizada.</span>
           	</td>
        ...
        <tr>
		    <td style="width: 35%;">
           	...
           	<td style="width: 55%;">
           		<span style="l65e-height:20px;font-size:11px;">: 20537556154</span>
           	</td>
        ...
        <tr>
		    <td style="width: 35%;">
           	...
           	<td style="width: 65%;">
           		<span style="line-height:30px;font-size:11px;">: AV. ERNESTO MONTAGNE #685 OFIC 304 URB. LA AURORA - MIRAFLORES</span>
           	</td>
        ...
        <tr>
		    <td style="width: 35%;">
           	...
           	<td style="width: 65%;">
           		<span style="line-height:30px;font-size:11px;">: GUILLERMO BARRIGA PEYRE </span>
           	</td>
        ...
        <tr>
		    <td style="width: 35%;">
           	...
           	<td style="width: 65%;">
           		<span style="line-height:30px;font-size:11px;">: DNI - 09532575</span>
           	</td>
    ...
    <table cellspacing="0" style="width: 100%; text-align: justify;  vertical-align: middle" >
        <tr>
		    ...
		    <td>
           		<span style="font-weight:bold;font-size:12px;">C. EL (LA) APRENDIZ</span>
           	</td>
    ...
    <table cellspacing="0" style="width: 100%; text-align: justify;  vertical-align: middle" >
        <tr>
		    <td style="width: 35%;">
           		<span style="line-height:30px;font-size:11px;">CENTRO DE FORMACION </span>
           	</td>
           	<td style="width: 65%;">
    ...
    <table cellspacing="0" style="width: 100%; text-align: justify;  vertical-align: middle" >
        <tr>
		    <td style="width: 35%;">
           		<span style="line-height:30px;font-size:11px;">PROFESIONAL QUE LO REPRESENTA</span>
           	</td>
           	<td style="width: 65%;">
           		<span style="line-height:30px;font-size:11px;">:  CETPRO Privado Tecnologia Centralizada</span>
           	</td>
    ...
    <table cellspacing="0" style="width: 100%; text-align: justify;  vertical-align: middle" >
        <tr>
		    <td style="width: 35%;">
           		<span style="line-height:30px;font-size:11px;">ESPECIALIDAD</span>
           	</td>
           	<td style="width: 65%;">
           		<span style="line-height:30px;font-size:11px;">: <?php echo $especialidad_convenio ?></span>
           	</td>
    ...
    <table cellspacing="0" style="width: 100%; text-align: justify;  vertical-align: middle" >
        <tr>
		    <td style="width: 35%;">
           	...
           	<td style="width: 65%;">
           		<span style="line-height:30px;font-size:11px;">: <?php echo $ocupacion_convenio ?></span>
           	</td>
    ...
    <table cellspacing="0" style="width: 100%; text-align: justify;  vertical-align: middle" >
        <tr>
		    ...
		    <td>
           		<span style="font-weight:bold;font-size:12px;">D. CONDICIONES DEL CONVENIO</span>
           	</td>
    ...
    <table cellspacing="0" style="width: 100%; text-align: justify;  vertical-align: middle" >
        <tr>
		    <td style="width: 35%;">
           	...
           	<td style="width: 65%;">
           		<span style="line-height:30px;font-size:11px;">: <?php echo $dias_convenio ?></span>
           	</td>
    ...
    <table cellspacing="0" style="width: 100%; text-align: justify;  vertical-align: middle" >
        <tr>
		    <td style="width: 35%;">
           		<span style="line-height:30px;font-size:11px;">DESDE EL</span>
           	</td>
           	<td style="width: 65%;">
           		<span style="line-height:30px;font-size:11px;">: <?php echo $fecha_ingreso_numero ?></span>
           	</td>
    ...
    <table cellspacing="0" style="width: 100%; text-align: justify;  vertical-align: middle" >
        <tr>
		    <td style="width: 35%;">
           		<span style="line-height:30px;font-size:11px;">HASTA EL</span>
           	</td>
           	<td style="width: 65%;">
           		<span style="line-height:30px;font-size:11px;">: <?php echo $fecha_fin_numero ?></span>
           	</td>
    ...
    <table cellspacing="0" style="width: 100%; text-align: justify;  vertical-align: middle" >
        <tr>
		    <td style="width: 35%;">
           		<span style="line-height:30px;font-size:11px;">HORARIO DE APRENDIZAJE</span>
           	</td>
           	<td style="width: 65%;">
           		<span style="line-height:30px;font-size:11px;">: De lunes a sábado. Pudiendo efectuarse de 9 a.m. a 18:00 p.m.  </span>
           	</td>
    ...
    <table cellspacing="0" style="width: 100%; text-align: justify;  vertical-align: middle" >
        <tr>
		    <td style="width: 35%;">
           	...
           	<td style="width: 65%;">
           		<span style="line-height:30px;font-size:11px;">  ó de 11:00 a.m. a 20:00 p.m. ó Turno Rotativo (La empresa otorgará al beneficiario </span>
           	</td>
    ...
    <table cellspacing="0" style="width: 100%; text-align: justify;  vertical-align: middle" >
        <tr>
		    <td style="width: 35%;">
           	...
           	<td style="width: 65%;">
           		<span style="line-height:30px;font-size:11px;">  01 hora de refrigerio en las mismas condiciones en que es concedido a sus trabajadores)</span>
           	</td>
    ...
    <table cellspacing="0" style="width: 100%; text-align: justify;  vertical-align: middle" >
        <tr>
		    <td style="width: 35%;">
           	...
           	<td style="width: 65%;">
           		<span style="line-height:30px;font-size:11px;">: PISO DE VENTAS</span>
           	</td>
...
<page backtop="15mm" backbottom="15mm" backleft="17mm" backright="15mm" style="font-size: 12pt; font-family: arial" >
    ...
    <table cellspacing="0" style="width: 100%; text-align: justify;  vertical-align: middle" >
        <tr>
		    ...
		    <td>
           		<span style="line-height:15px;font-size:11.5px;">EL APRENDIZ manifiesta su interés y necesidad de efectuar sus actividades de aprendizaje en LA EMPRESA, para los fines de obtener la certificación respectiva. Por su parte, LA EMPRESA acepta colaborar, tanto con el mencionado CENTRO DE FORMACIÓN PROFESIONAL como con EL APRENDIZ en esta tarea formativa.</span>
           	</td>
    ...
    <table cellspacing="0" style="width: 100%; text-align: justify;  vertical-align: middle" >
        <tr>
		    ...
		    <td>
           		<span style="line-height:15px;font-size:11.5px;">EL (LA) APRENDIZ desempeñará las actividades formativas de <?php echo $especialidad_convenio ?> en el área de <?php echo $area_postu ?>. En el domicilio de la empresa ubicado en <?php echo $direccion_tienda_postu ?> de acuerdo a las condiciones generales señalados en el literal d).</span>
           	</td>
    ...
    <table cellspacing="0" style="width: 100%; text-align: justify;  vertical-align: middle" >
        <tr>
		    ...
		    <td>
				...
				<br>1) Brindar orientación y capacitación técnica y profesional a EL APRENDIZ, dentro de su área de formación académica, así como evaluar su aprendizaje.
				<br>2) Designar a un supervisor para impartir la orientación correspondiente a EL APRENDIZ y para verificar el desarrollo y cumplimiento del Plan de Específico de Aprendizaje.
				<br>3) Emitir los informes que requiera el CENTRO DE FORMACIÓN PROFESIONAL, en relación con el aprendizaje de EL APRENDIZ.
				<br>4) No cobrar suma alguna AL APRENDIZ por la Formación brindada o impartida.
				<br>5) Pagar puntualmente a EL APRENDIZ una subvención mensual convenida.
				<br>6) Otorgar a EL APRENDIZ una subvención adicional equivalente a media subvención económica mensual cada seis meses de 		duración continua del aprendizaje.
				<br>7) Otorgar un descanso de quince (15) días debidamente subvencionados cuando la duración del aprendizaje sea superior a doce
				(12) meses.
				<br>8) Cubrir los riesgos de enfermedad y accidentes de EL APRENDIZ, a través de EsSalud o de un seguro privado con una cobertura equivalente a catorce (14) subvenciones mensuales en caso de enfermedad y treinta (30) por accidente.</span>
           	</td>
    ...
    <table cellspacing="0" style="width: 100%; text-align: justify;  vertical-align: middle" >
        <tr>
		    ...
		    <td>
           		<span style="line-height:15px;font-size:11.5px;">Para efectos del presente convenio EL APRENDIZ, se obliga a:
				<br>1) Suscribir un convenio de aprendizaje con LA EMPRESA acatando las disposiciones formativas que se le asignen.
				<br>2) Desarrollar sus actividades de aprendizaje con disciplina y responsabilidad.
				<br>3) Cumplir con el desarrollo del Plan Específico de Aprendizaje que aplique LA EMPRESA.
    ...
    <table cellspacing="0" style="width: 100%; text-align: justify;  vertical-align: middle" >
        <tr>
		    ...
		    <td>
           		<span style="line-height:15px;font-size:11.5px;">Para efectos del presente convenio, EL CENTRO DE FORMACIÓN PROFESIONAL se obliga a:
				<br>1) Planificar y desarrollar los programas formativos que respondan a las necesidades del mercado laboral con participación del sector productivo.
				<br>2) Dirigir y conducir las actividades de formación de EL APRENDIZ en coordinación con LA EMPRESA.
				<br>3) Supervisar, evaluar y certificar las actividades formativas.
				<br>4) Coordinar con la empresa el mecanismo de monitoreo y supervisión de las actividades que desarrolla el APRENDIZ</span>
           	</td>
    ...
    <table cellspacing="0" style="width: 100%; text-align: justify;  vertical-align: middle" >
        <tr>
		    ...
		    <td>
           		<span style="line-height:15px;font-size:11.5px;">LA EMPRESA ha contratado el seguro de MAPFRE PERÚ COMPAÑÍA DE SEGUROS Y REASEGUROS para cubrir los riesgos de enfermedad y accidentes de EL APRENDIZ.</span>
           	</td>
	...
	<table cellspacing="0" style="width: 100%; text-align: justify;  vertical-align: middle" >
        <tr>
		    ...
		    <td>
           		<span style="font-weight:bold;font-size:11.5px;text-decoration: underline;">SEPTIMO:</span>
           	</td>
    ...
    <table cellspacing="0" style="width: 100%; text-align: justify;  vertical-align: middle" >
        <tr>
		    ...
		    <td>
           		<span style="line-height:15px;font-size:11.5px;">LA EMPRESA concederá a EL APRENDIZ una subvención económica mensual de S/. <?php echo $salario_postu ?>.00 (<?php echo $salario_letras_postu ?>). De conformidad con el Artículo 47° de la Ley N° 28518, esta subvención económica mensual no tiene carácter remunerativo y no está afecta al pago del Impuesto a la Renta, otros impuestos, contribuciones ni aportaciones de ningún tipo a cargo de LA EMPRESA. La subvención económica mensual no está sujeta a ningún tipo de retención a cargo de EL APRENDIZ, salvo afiliación facultativa por parte de éste a un sistema pensionario.</span>
           	</td>
...
<page backtop="15mm" backbottom="15mm" backleft="17mm" backright="15mm" style="font-size: 12pt; font-family: arial" >
    ...
    <table cellspacing="0" style="width: 100%; text-align: justify;  vertical-align: middle" >
        <tr>
		    <td>
           		<span style="line-height:15px;font-size:11.5px;">Las partes acuerdan la aplicación de las causas de modificación, suspensión y terminación del convenio, que se detallan a continuación:<br>
				Son causas de modificación del convenio:</span>
           	</td>
	...
	<table cellspacing="0" style="width: 100%; text-align: justify;  vertical-align: middle" >
        <tr>
		    <td>
           		<span style="line-height:15px;font-size:11.5px;">Son causas de suspensión del convenio:</span>
           	</td>
    ...
    <table cellspacing="0" style="width: 100%; text-align: justify;  vertical-align: middle" >
        <tr>
        	<td>&nbsp;&nbsp;</td>
		    <td>
           		<span style="line-height:15px;font-size:11.5px;">a) Por acuerdo entre EL APRENDIZ, LA EMPRESA Y EL CENTRO DE FORMACIÓN PROFESIONAL.
				
				<br>b) La enfermedad y el accidente comprobados, sin perjuicio de lo establecido en el numeral ocho (8) de la cláusula tercera del presente convenio.
				<br>c) Por descanso físico subvencionado en caso que el convenio se prorrogue a un plazo mayor de doce meses.
				<br>d) El caso fortuito o fuerza mayor.</span>
           	</td>
    ...
    <table cellspacing="0" style="width: 100%; text-align: justify;  vertical-align: middle" >
        <tr>
        	<td>&nbsp;&nbsp;</td>
		    <td>
           		<span style="line-height:15px;font-size:11.5px;">a) El cumplimiento del plazo estipulado en la letra D, Condiciones del Convenio, de las Condiciones Generales.
				<br>b) El mutuo disenso entre EL APRENDIZ y LA EMPRESA.
				<br>c) El fallecimiento de EL APRENDIZ.
				<br>d) La invalidez absoluta permanente.
				<br>e) No guardar reserva de toda la información y/o documentación que EL APRENDIZ conozca durante el desarrollo del aprendizaje.
				<br>f) El incumplimiento de cualquiera de las obligaciones por parte de EL APRENDIZ y específicamente las contempladas en la cláusula
				cuarta del presente convenio.
				<br>g) El incumplimiento de cualquiera de las obligaciones por parte del CENTRO DE FORMACIÓN PROFESIONAL, específicamente las
				contempladas en la cláusula quinta del presente convenio.
				<br>h) Por renuncia o retiro voluntario por parte de EL APRENDIZ, mediante aviso a LA EMPRESA con antelación de diez (10) días
				hábiles</span>
           	</td>
    ...
    <table cellspacing="0" style="width: 100%; text-align: justify;  vertical-align: middle" >
        <tr>
		    ...
		    <td>
           		<span style="line-height:15px;font-size:11.5px;">EL APRENDIZ declara conocer la naturaleza del presente convenio, el cual no tiene carácter laboral, de tal modo que sólo genera para las partes, los derechos y obligaciones específicamente previsto en el mismo y en el texto de la Ley N° 28518 y el Decreto Supremo N° 007-2005-TR.</span>
           	</td>
    ...
    <table cellspacing="0" style="width: 100%; text-align: justify;  vertical-align: middle" >
        <tr>
		    ...
		    <td>
           		<span style="line-height:15px;font-size:11.5px;">Para todos los efectos relacionados con el presente convenio, las partes señalan como su domicilio el que aparece consignado en la parte introductoria de éste, los cuales se tendrán por válidos en tanto la variación no haya sido comunicada por escrito a la otra parte. Las partes, después de leído el presente convenio, se ratifican en su contenido y lo suscriben en señal de conformidad en cuatro ejemplares; el primero para LA EMPRESA, el segundo para EL APRENDIZ, el tercero para EL CENTRO DE FORMACIÓN PROFESIONAL, y el cuarto será puesto en conocimiento y registrado ante la Autoridad Administrativa de Trabajo dentro de los quince (15) días naturales de la suscripción); de lo que damos fe.</span>
           	</td>
	...
	<table cellspacing="0" style="width: 100%; text-align: right;  vertical-align: middle" >
        <tr>
			...
			<td style="width: 40%; color: black;font-size:12px;text-align:middle;font-weight:bold;">
				<span>CETPRO Priv. Tec. Centralizada</span>
            </td>
			<td style="width: 30%; color: black;font-size:12px;text-align:middle;font-weight:bold;">
	...
	<table cellspacing="0" style="width: 100%; text-align: right;  vertical-align: middle" >
        <tr>
			...
			<td style="width: 40%; color: black;font-size:12px;text-align:middle;font-weight:bold;">
				<span>GUILLERMO BARRIGA PEYRE</span>
            </td>
			<td style="width: 30%; color: black;font-size:12px;text-align:middle;font-weight:bold;">				
			</td>
...
<page backtop="15mm" backbottom="15mm" backleft="17mm" backright="15mm" style="font-size: 12pt; font-family: arial" >
	...
	<table cellspacing="0" style="width: 100%; text-align: justify;  vertical-align: middle" >
        <tr>
		    ...
		    <td style="width: 90%;">
           		<span style="font-size:12px;">Plan Específico de Aprendizaje con predominio en el Centro de Formación Profesional.</span>
           	</td>
	...
	<table cellspacing="0" style="width: 100%; text-align: left;  vertical-align: middle">
		<tr>
			<td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000;width: 100%;font-size:12px;height: 13px"><?php echo $ocupacion_convenio ?></td>
		</tr>
	</table>
	<br>
	<table cellspacing="0" style="width: 100%; text-align: justify;  vertical-align: middle" >
	...
	<table cellspacing="0" style="width: 100%; text-align: left;  vertical-align: middle">
		<tr>
			<td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000;width: 100%;font-size:12px;height: 13px">CETPRO Privado Tecnología Centralizada</td>
		</tr>
	</table>
	<br>
	<table cellspacing="0" style="width: 100%; text-align: justify;  vertical-align: middle" >
	...
	<table cellspacing="0" style="width: 100%; text-align: left;  vertical-align: middle">
		<tr>
			<td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000;width: 100%;font-size:12px;height: 13px">GUILLERMO BARRIGA PEYRE</td>
		</tr>
	</table>
	<br>
	<table cellspacing="0" style="width: 100%; text-align: justify;  vertical-align: middle" >
	...
	<table cellspacing="0" style="width: 100%; text-align: justify;  vertical-align: middle" >
        <tr>
		    ...
		    <td>
           		<span style="font-size:12px;">1.6 Nombres y Apellidos del beneficiario</span>
           	</td>
	...
	<table cellspacing="0" style="width: 100%; text-align: center;  vertical-align: middle">
		<tr>
			...
			<td style="border-top: 1px solid #000000; border-bottom: 0px solid #000000; border-left: 0px solid #000000; border-right: 1px solid #000000;width: 65%;font-size:12px;">6 días a la semana (Lunes a Sábado) pudiendo efectuarse de 9 a.m. a 18:00 p.m. ó de 11:00 a.m. a 20:00 p.m. ó Turno Rotativo (La empresa otorgará al beneficiario 01 hora de refrigerio en las mismas condiciones en que es concedido a sus trabajadores)</td>
		</tr>
	</table>
	<table cellspacing="0" style="width: 100%; text-align: center;  vertical-align: middle">
		<tr>
			...
			<td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 0px solid #000000; border-right: 1px solid #000000;width: 65%;font-size:12px;"><?php echo $ocupacion_convenio ?></td>
		</tr>
	</table>
</page>
...
<page backtop="15mm" backbottom="15mm" backleft="25mm" backright="15mm" style="font-size: 12pt; font-family: arial" >
	...
	<table cellspacing="0" style="width: 100%; text-align: left;  vertical-align: middle">
		<tr>
			<td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000;width: 100%;font-size:12px;"><?php echo $objetivos ?></td>
		</tr>
	</table>
	<table cellspacing="0" style="width: 100%; text-align: justify;  vertical-align: middle" >
        <tr>
	...
	<table cellspacing="0" style="width: 100%; text-align: left;  vertical-align: middle">
		<tr>
			<td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000;width: 100%;font-size:12px;"><?php echo $funcion ?></td>
		</tr>
	</table>
	<br>
	<table cellspacing="0" style="width: 100%; text-align: justify;  vertical-align: middle" >
	...
	<table cellspacing="0" style="width: 100%; text-align: left;  vertical-align: middle">
		<tr>
			<td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000;width: 100%;font-size:12px;"><?php echo $actividades ?></td>
		</tr>
	</table>
	<br>
	<table cellspacing="0" style="width: 100%; text-align: justify;  vertical-align: middle" >
	...
	<table cellspacing="0" style="width: 100%; text-align: center;  vertical-align: middle">
		<tr>
			<td style="border-top: 1px solid #000000; border-bottom: 0px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000;width: 65%;font-size:12px;"><?php echo $competencia_ecpecifica_uno ?> específicas</td>
			<td style="border-top: 1px solid #000000; border-bottom: 0px solid #000000; border-left: 0px solid #000000; border-right: 1px solid #000000;width: 35%;font-size:12px;"><?php echo $indicador_logro_especifico_uno ?></td>
		</tr>
	</table>
	<table cellspacing="0" style="width: 100%; text-align: center;  vertical-align: middle">
		<tr>
			<td style="border-top: 1px solid #000000; border-bottom: 0px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000;width: 65%;font-size:12px;"><?php echo $competencia_ecpecifica_dos ?> específicas</td>
			<td style="border-top: 1px solid #000000; border-bottom: 0px solid #000000; border-left: 0px solid #000000; border-right: 1px solid #000000;width: 35%;font-size:12px;"><?php echo $indicador_logro_especifico_dos ?></td>
		</tr>
	</table>
	<table cellspacing="0" style="width: 100%; text-align: center;  vertical-align: middle">
		<tr>
			<td style="border-top: 1px solid #000000; border-bottom: 0px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000;width: 65%;font-size:12px;"><?php echo $competencia_ecpecifica_tres ?> específicas</td>
			<td style="border-top: 1px solid #000000; border-bottom: 0px solid #000000; border-left: 0px solid #000000; border-right: 1px solid #000000;width: 35%;font-size:12px;"><?php echo $indicador_logro_especifico_tres ?></td>
		</tr>
	</table>
	<table cellspacing="0" style="width: 100%; text-align: center;  vertical-align: middle">
		<tr>
			<td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000;width: 65%;font-size:12px;"><?php echo $competencia_ecpecifica_cuatro ?> específicas</td>
			<td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 0px solid #000000; border-right: 1px solid #000000;width: 35%;font-size:12px;"><?php echo $indicador_logro_especifico_cuatro ?></td>
		</tr>
	</table>
	<br>
	<table cellspacing="0" style="width: 100%; text-align: justify;  vertical-align: middle" >
	...
	<table cellspacing="0" style="width: 100%; text-align: center;  vertical-align: middle">
		<tr>
			<td style="border-top: 1px solid #000000; border-bottom: 0px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000;width: 65%;font-size:12px;"><?php echo $competencia_generica_uno ?> específicas</td>
			<td style="border-top: 1px solid #000000; border-bottom: 0px solid #000000; border-left: 0px solid #000000; border-right: 1px solid #000000;width: 35%;font-size:12px;"><?php echo $indicador_logro_generica_uno ?></td>
		</tr>
	</table>
	<table cellspacing="0" style="width: 100%; text-align: center;  vertical-align: middle">
		<tr>
			<td style="border-top: 1px solid #000000; border-bottom: 0px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000;width: 65%;font-size:12px;"><?php echo $competencia_generica_dos ?> específicas</td>
			<td style="border-top: 1px solid #000000; border-bottom: 0px solid #000000; border-left: 0px solid #000000; border-right: 1px solid #000000;width: 35%;font-size:12px;"><?php echo $indicador_logro_generica_dos ?></td>
		</tr>
	</table>
	<table cellspacing="0" style="width: 100%; text-align: center;  vertical-align: middle">
		<tr>
			<td style="border-top: 1px solid #000000; border-bottom: 0px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000;width: 65%;font-size:12px;"><?php echo $competencia_generica_tres ?> específicas</td>
			<td style="border-top: 1px solid #000000; border-bottom: 0px solid #000000; border-left: 0px solid #000000; border-right: 1px solid #000000;width: 35%;font-size:12px;"><?php echo $indicador_logro_generica_tres ?></td>
		</tr>
	</table>
	<table cellspacing="0" style="width: 100%; text-align: center;  vertical-align: middle">
		<tr>
			<td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000;width: 65%;font-size:12px;"><?php echo $competencia_generica_cuatro ?> específicas</td>
			<td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 0px solid #000000; border-right: 1px solid #000000;width: 35%;font-size:12px;"><?php echo $indicador_logro_generica_cuatro ?></td>
		</tr>
	</table>
	<br>
	<table cellspacing="0" style="width: 100%; text-align: justify;  vertical-align: middle" >
...
<page backtop="15mm" backbottom="15mm" backleft="15mm" backright="15mm" style="font-size: 12pt; font-family: arial" >
	...
	<table cellspacing="0" style="width: 100%; text-align: center;  vertical-align: middle">
		<tr>
			...
			<td style="border-top: 1px solid #000000; border-bottom: 0px solid #000000; border-left: 0px solid #000000; border-right: 1px solid #000000;width: 65%;font-size:12px;">Piso de ventas.</td>
		</tr>
	...
	<table cellspacing="0" style="width: 100%; text-align: justify;  vertical-align: middle" >
        <tr>
        	<td>&nbsp;&nbsp;&nbsp;</td>
		    <td>
           		<span style="font-size:12px;">1.	Piso de Ventas</span>
           	</td>
	...
	<table cellspacing="0" style="width: 100%; text-align: justify;  vertical-align: middle" >
        <tr>
        	<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
		    <td>
           		<span style="font-size:12px;">Cada joven será evaluado respecto a sus competencias personales de manera constante y esta evaluación será comparada con las competencias requeridas, previamente definidas. Se ha contemplado lo siguiente:</span>
           	</td>
	...
	<table cellspacing="0" style="width: 100%; text-align: justify;  vertical-align: middle" >
        <tr>
        	<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
		    <td>
           		<span style="font-size:12px;">• Contacto con el personal que tendrá a su cargo la supervisión de los alumnos, previa coordinación.</span>
           	</td>
	...
	<table cellspacing="0" style="width: 100%; text-align: justify;  vertical-align: middle" >
        <tr>
        	<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
		    <td>
           		<span style="font-size:12px;">• Entrega a la empresa de los formatos de supervisión e informes.</span>
           	</td>
	...
	<table cellspacing="0" style="width: 100%; text-align: justify;  vertical-align: middle" >
        <tr>
        	<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
		    <td>
           		<span style="font-size:12px;">• Coordinación de fechas de visita por parte de CETPRO Privado Tecnología Centralizada a las instalaciones de la empresa.</span>
           	</td>
	...
	<table cellspacing="0" style="width: 100%; text-align: justify;  vertical-align: middle" >
        <tr>
        	<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
		    <td>
           		<span style="font-size:12px;">• Seguimiento individual por cada alumno y evaluación de su incorporación a las normas y procedimientos de la empresa, previa coordinación.</span>
           	</td>
	...
	<table cellspacing="0" style="width: 100%; text-align: justify;  vertical-align: middle" >
        <tr>
        	<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
		    <td>
           		<span style="font-size:12px;">Este anexo contiene información fidedigna, que compromete en su ejecución a los firmantes.</span>
           	</td>
			...
			<td style="width: 55%; color: black;font-size:11px;text-align:left;">
				<table cellspacing="0" style="width: 100%; text-align: left;  vertical-align: middle">
					...
					<tr>
						...
						<td style="border-top: 1px solid #000000; border-bottom: 0px solid #000000; border-left: 0px solid #000000; border-right: 1px solid #000000;width: 65%;"><?php echo $especialidad_convenio ?></td>
					</tr>
					<tr>
...
?>
	...
	<table cellspacing="0" style="width: 100%; text-align: center;  vertical-align: middle;font-size:10px;" >
		...
		<tr>
			...
			<td style="border-top: 0px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 0px solid #000000;width: 15%;height: 2%"><?php echo $registroReferencia['De_Carrera'] ?></td>
		...
		?>
		<tr>
			<td style="border-top: 0px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 0px solid #000000;width: 15%; height: 2%;font-weight:bold;background-color: #C0C0C0"></td>
			<td style="border-top: 0px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 0px solid #000000;width: 35%;height: 2%"></td>
			<td style="border-top: 0px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 0px solid #000000;width: 9%;height: 2%"></td>
			<td style="border-top: 0px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 0px solid #000000;width: 9%;height: 2%"></td>
			<td style="border-top: 0px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 0px solid #000000;width: 15%;height: 2%"></td>
			<td style="border-top: 0px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000;width: 17%;height: 2%"></td>
		</tr>
...
<page backtop="20mm" backbottom="20mm" backleft="20mm" backright="20mm" style="font-size: 12pt; font-family: arial" >
    ...
    <table cellspacing="0" style="width: 100%;">
        <tr>
            <td style="width: 35%; color: black;font-size:15px;text-align:justify">
                
            </td>
			<td style="width: 60%; color: #444444;">
                <span style="color: black;font-size:15px;font-weight:bold;text-decoration: underline black;">DECLARACIÓN JURADA</span>
            </td>
    ...
    <table cellspacing="0" style="width: 100%; text-align: justify;  vertical-align: middle" >
        <tr>
		    <td>
           		<span style="line-height:20px;font-size:12px;">Yo, <?php echo $nom_postu ?> Identificado con <?php echo $tipo_documento ?> Nro. <?php echo $dni_postulante ?></span>
	...
	<table cellspacing="0" style="width: 100%; text-align: justify;  vertical-align: middle" >
        <tr>
		    <td>
           		<span style="line-height:15px;font-weight:bold;text-decoration: underline black;font-size:12px;">DECLARO BAJO JURAMENTO</span>
    ...
    <table cellspacing="0" style="width: 100%; text-align: justify;  vertical-align: middle" >
        <tr>
		    <td>
           		<span style="line-height:20px;font-size:12px;">Que acepto iniciar un programa de aprendizaje en la empresa TAI LOY S. A. bajo la modalidad de Aprendizaje con predominio en la empresa durante el período especificado según el convenio firmado. <br>Para lo cual declaro NO encontrarme realizando estudios básicos (secundaria) ni de carreras técnicas y/o Universitarias y se me han indicado las siguientes condiciones:</span>
    ...
    <table cellspacing="0" style="width: 100%; text-align: justify;  vertical-align: middle" >
        <tr>
		    <td>
           		<span style="line-height:20px;font-size:12px;">- Disponibilidad a tiempo completo
				<br>- Jornada laboral 8 horas diarias, 06 días a la semana, 01 día de descanso; el horario será especificado por la empresa según requerimiento al momento de la incorporación.
				<br>- Subvención económica mensual especificada en el convenio.
				<br>- Al momento de iniciar labores deberé asistir a la capacitación en MANOS DINÁMICAS a través de la Plataforma virtual.
				<br>- Deberé hacer entrega de los documentos que se me soliciten antes de finalizar la Inducción de lo contrario no podré iniciar labores.
				<br>- Teniendo conocimiento que los horarios de clase forman parte de la jornada formativa laborals.
				<br>- De corroborarse que alguna información brindada no es verdadera estará finalizando su relación con Tai Loy y Manos Dinámicas.
				<br>- Previo a la incorporación deberé firmar el Convenio de Aprendizaje con Predominio en la Empresa y El Plan de Capacitación.
</span>
...
<page backtop="20mm" backbottom="20mm" backleft="20mm" backright="20mm" style="font-size: 12pt; font-family: arial" >
    ...
    <table cellspacing="0" style="width: 100%;">
        <tr>
			...
			<td style="width: 60%; color: #444444;">
                <span style="color: black;font-size:15px;font-weight:bold;text-decoration: underline black;">COMPROMISO DE ESTUDIOS</span>
            </td>
			<td style="width: 20%;text-align:right">
    ...
    <table cellspacing="0" style="width: 100%; text-align: justify;  vertical-align: middle" >
        <tr>
		    <td>
           		<span style="line-height:20px;font-size:12px;">Por medio del presente yo, <?php echo $nom_postu ?> identificado(a) con <?php echo $tipo_documento ?> Nro. <?php echo $dni_postulante ?> domiciliado(a) en <?php echo $direccion_postu ?> - <?php echo $nombre_distrito_postu ?> con fecha de nacimiento *<?php echo $fecha_nacimiento_postu ?> estudiante del Programa de <?php echo $ocupacion_convenio ?> en el CETPRO Privado Centro de Educación Tecnología Centralizada, tengo conocimiento que Tai Loy S.A. Subvenciona totalmente mis estudios bajo la modalidad de Aprendizaje con Predominio en la Empresa durante el período de duración del convenio firmado; comprometiéndome a ingresar a mis cursos virtuales.</span>
    ...
    <table cellspacing="0" style="width: 100%; text-align: justify;  vertical-align: middle" >
        <tr>
		    <td>
           		<span style="line-height:20px;font-size:12px;">Así mismo tengo pleno conocimiento que los espacios programados de estudio son a través de la plataforma virtual, en ese sentido ante una inasistencia injustificada de mi parte a los cursos, reconozco que estoy faltando al convenio firmado y por tanto Tai Loy S.A.. Procederá según su reglamento.</span>
    ...
    <table cellspacing="0" style="width: 100%; text-align: justify;  vertical-align: middle" >
        <tr>
		    <td>
           		<span style="line-height:20px;font-size:12px;">Agradeciéndole anticipadamente, la atención de lo solicitado, me despido</span>
    ...
    <table cellspacing="0" style="width: 100%; text-align: justify;  vertical-align: middle" >
        <tr>
		    ...
		    <td>
           		<span style="font-weight:bold;font-size:12px;">Apellidos y Nombres: <?php echo $nom_postu ?></span>
           	</td>
...
<page backtop="15mm" backbottom="15mm" backleft="17mm" backright="15mm" style="font-size: 11pt; font-family: arial" >
    <table cellspacing="0" style="width: 100%;">
        <tr>
			...
			<td style="width: 50%; color: #444444;">
                <span style="color: black;font-size:12px;font-weight:bold; text-decoration: underline;">ACUERDO DE RESERVA Y CONFIDENCIALIDAD</span>
            </td>
			<td style="width: 25%;text-align:right">
    ...
    <table cellspacing="0" style="width: 100%; text-align: justify;  vertical-align: middle" >
        <tr>
		    <td>
           		<span style="line-height:20px;font-size:12px;">Conste por el presente documento el acuerdo de confidencialidad que celebran de una parte TAI LOY S.A., identificada con RUC N° 20100049181, con domicilio en Jr. Mariano Odicio N° 153, Urb. Miraflores, Surquillo., debidamente representada por Huarcaya Silva Manuel Enrique, identificado con DNI N° 06225424, a quien en adelante se le denominara LA EMPRESA y,de la otra parte <?php echo $nom_postu ?> identificado(a) con <?php echo $tipo_documento ?> Nro. <?php echo $dni_postulante ?> con domicilio en  <?php echo $direccion_postu ?>  <?php echo $provincia_postu ?> y Departamento de <?php echo $nombre_departamento_postu ?>, a quien en adelante se le denominara "EL APRENDIZ", en los términos y condiciones de las cláusulas siguientes:</span>
	...
	<table cellspacing="0" style="width: 100%; text-align: justify;  vertical-align: middle" >
        <tr>
		    <td>
           		<span style="line-height:15px;font-size: 9pt;font-weight:bold;text-decoration: underline black;">PRIMERA: </span>
    ...
    <table cellspacing="0" style="width: 100%; text-align: justify;  vertical-align: middle" >
        <tr>
		    <td>
           		<span style="line-height:15px;font-size: 9pt;">El presente Acuerdo se celebra, existiendo plena y libre voluntad de las partes en todos sus términos. </span>
           	</td>
        </tr>
    </table>
    <br>
	<table cellspacing="0" style="width: 100%; text-align: justify;  vertical-align: middle" >
        <tr>
		    <td>
           		<span style="line-height:15px;font-size: 9pt;font-weight:bold;text-decoration: underline black;">SEGUNDA: </span>
    ...
    <table cellspacing="0" style="width: 100%; text-align: justify;  vertical-align: middle" >
        <tr>
		    <td>
           		<span style="line-height:15px;font-size: 9pt;">EL APRENDIZ durante el tiempo que dure su convenio de aprendizaje, tiene acceso a información de carácter reservado de LA EMPRESA incluidos secretos administrativos, costos, procedimientos comerciales y/o profesionales. </span>
           	</td>
        </tr>
    </table>
    <br>
	<table cellspacing="0" style="width: 100%; text-align: justify;  vertical-align: middle" >
        <tr>
		    <td>
           		<span style="line-height:15px;font-size: 9pt;font-weight:bold;text-decoration: underline black;">TERCERA: CLAUSULA DE RESERVA Y CONFIDENCIALIDAD: </span>
    ...
    <table cellspacing="0" style="width: 100%; text-align: justify;  vertical-align: middle" >
        <tr>
		    <td>
           		<span style="line-height:15px;font-size: 9pt;">EL APRENDIZ deberá cumplir durante el tiempo que dure su convenio de aprendizaje con todas y cada una de las obligaciones para las cuales fue contratado, según las necesidades de LA EMPRESA. </span>
           	</td>
        </tr>
    </table>
    <br>
    <table cellspacing="0" style="width: 100%; text-align: justify;  vertical-align: middle" >
        <tr>
		    <td>
           		<span style="line-height:15px;font-size: 9pt;">EL APRENDIZ se obliga, del mismo modo, a mantener en secreto toda información que llegue a su conocimiento en relación a los procedimientos, métodos, diseños, proyectos, documentos, negocios, actividades y recursos, sistemas, archivos e información virtual y demás de LA EMPRESA, sus asociados, proveedores y/o clientes, aun cuando dichas personas hayan prestado su consentimiento y autorización en forma expresa incondicional e irrevocable a LA EMPRESA a utilizar los datos personales como los datos sensibles definidos en la Ley de Protección de Datos Personales regulada por la Ley No.29733, así como en su Reglamento aprobado por Decreto Supremo No.003-2013-JUS. </span>
           	</td>
        </tr>
    </table>
    <br>
    ...
    <table cellspacing="0" style="width: 100%; text-align: justify;  vertical-align: middle" >
        <tr>
		    <td>
           		<span style="line-height:15px;font-size: 9pt;">Esta obligación subsistirá aun después de terminado el Convenio de Aprendizaje y su incumplimiento origina la correspondiente responsabilidad por daños y perjuicios, sin perjuicio de la persecución penal por el delito de violación del secreto profesional previsto en el artículo 165 del actual Código Penal</span>
           	</td>
        </tr>
    </table>
    <br>
	<table cellspacing="0" style="width: 100%; text-align: justify;  vertical-align: middle" >
        <tr>
		    <td>
           		<span style="line-height:15px;font-size: 9pt;font-weight:bold;text-decoration: underline black;">CUARTA: PRIVACIDAD Y PROTECCIÓN DE INFORMACIÓN PERSONAL DEL APRENDIZ</span>
    ...
    <table cellspacing="0" style="width: 100%; text-align: justify;  vertical-align: middle" >
        <tr>
		    <td>
           		<span style="line-height:15px;font-size: 9pt;">EL APRENDIZ autoriza a LA EMPRESA a utilizar, directa o indirectamente durante el plazo de duración del convenio de aprendizaje y con motivo de la misma, de conformidad con lo dispuesto en la Ley N° 29733, Ley de Protección de Datos Personales y sus normas reglamentarias, complementarias y modificatorias.  </span>
           	</td>
        </tr>
    </table>
    <br>
    <table cellspacing="0" style="width: 100%; text-align: justify;  vertical-align: middle" >
        <tr>
		    <td>
           		<span style="line-height:15px;font-size: 9pt;">Al respecto, las partes acuerdan que los datos personales proporcionados por EL APRENDIZ a LA EMPRESA quedan incorporados a su banco de datos, pudiendo LA EMPRESA utilizar dicha información para efectos de la gestión de los productos y/o servicios solicitados y/o contratados incluyendo evaluaciones financieras, procesamiento de datos, formalizaciones contractuales, cobro de deudas, gestión de operaciones financieras y remisión de correspondencia, entre otros, la misma que podrá ser realizada a través de terceros.</span>
           	</td>
        </tr>
    </table>
    <br>
    <table cellspacing="0" style="width: 100%; text-align: justify;  vertical-align: middle" >
        <tr>
		    <td>
           		<span style="line-height:15px;font-size: 9pt;">Las partes consideran como información personal de EL APRENDIZ de manera enunciativa más no limitativa, los datos personales que figuran en su currículo vitae, en los documentos y formularios de ingreso de LA EMPRESA, así como aquellos obtenidos por LA EMPRESA como consecuencia del convenio de aprendizaje de EL APRENDIZ. </span>
           	</td>
        </tr>
    </table>
    <br>
    <table cellspacing="0" style="width: 100%; text-align: justify;  vertical-align: middle" >
        <tr>
		    <td>
           		<span style="line-height:15px;font-size: 9pt;">EL APRENDIZ está de acuerdo en que dicha información pueda ser transferida por EL EMPLEADOR a su personal siempre que requieran y sea necesario conocer dicha información para el ejercicio de sus funciones, a terceras personas y/o empresas contratadas que necesiten conocer también la información de EL APRENDIZ para la prestación de sus servicios y/o a sus empresas vinculadas, domiciliadas o no en el Perú, para la consolidación de datos, preparación de estadísticas corporativas, elaboración de políticas, etc.  </span>
           	</td>
        </tr>
    </table>
</page>
...
<page backtop="15mm" backbottom="15mm" backleft="17mm" backright="15mm" style="font-size: 11pt; font-family: arial" >
	<table cellspacing="0" style="width: 100%; text-align: justify;  vertical-align: middle" >
        <tr>
		    <td>
           		<span style="line-height:15px;font-size: 9pt;font-weight:bold;text-decoration: underline black;">QUINTA:</span>
    ...
    <table cellspacing="0" style="width: 100%; text-align: justify;  vertical-align: middle" >
        <tr>
		    <td>
           		<span style="line-height:15px;font-size: 9pt;">Si EL APRENDIZ conoce por cualquier medio de alguna violación a este Convenio, notificará inmediatamente por escrito a la gerencia general de LA EMPRESA, estando obligado a otorgar todos los detalles de los que dispone y con la dirección de LA EMPRESA tomará las medidas que ésta pueda requerir con el fin de minimizar la pérdida que de otro modo pudiera sufrir LA EMPRESA como resultado de dicha violación.</span>
           	</td>
        </tr>
    </table>
    <br>
    <table cellspacing="0" style="width: 100%; text-align: justify;  vertical-align: middle" >
        <tr>
		    <td>
           		<span style="line-height:15px;font-size: 9pt;font-weight:bold;text-decoration: underline black;">SEXTA:</span>
    ...
    <table cellspacing="0" style="width: 100%; text-align: justify;  vertical-align: middle" >
        <tr>
		    <td>
           		<span style="line-height:15px;font-size: 9pt;">Las obligaciones en este Acuerdo son continuas y en particular, subsistirán a la extinción de la relación o vínculo laboral entre las partes. </span>
           	</td>
        </tr>
    </table>
    <br>
    <table cellspacing="0" style="width: 100%; text-align: justify;  vertical-align: middle" >
        <tr>
		    <td>
           		<span style="line-height:15px;font-size: 9pt;font-weight:bold;text-decoration: underline black;">SÉPTIMA:</span>
    ...
    <table cellspacing="0" style="width: 100%; text-align: justify;  vertical-align: middle" >
        <tr>
		    <td>
           		<span style="line-height:15px;font-size: 9pt;">Las partes acuerdan expresamente que EL APRENDIZ no adquiere derecho de propiedad intelectual alguno sobre la información confidencial a la que tenga acceso o la que pudiera crear en el desarrollo de sus labores.</span>
           	</td>
        </tr>
    </table>
    <br>
    <table cellspacing="0" style="width: 100%; text-align: justify;  vertical-align: middle" >
        <tr>
		    <td>
           		<span style="line-height:15px;font-size: 9pt;">En tal sentido, LA EMPRESA es el único y exclusivo titular de todo derecho e interés que recaiga sobre dicha información.</span>
           	</td>
        </tr>
    </table>
    <br>
    <table cellspacing="0" style="width: 100%; text-align: justify;  vertical-align: middle" >
        <tr>
		    <td>
           		<span style="line-height:15px;font-size: 9pt;font-weight:bold;text-decoration: underline black;">OCTAVA:</span>
    ...
    <table cellspacing="0" style="width: 100%; text-align: justify;  vertical-align: middle" >
        <tr>
		    <td>
           		<span style="line-height:15px;font-size: 9pt;">EL APRENDIZ reconoce que recibe de LA EMPRESA capacitación profesional en diversos aspectos de la operación del negocio, especialmente la capacitación en todos los temas relacionados con la operación de <?php echo $especialidad_convenio ?>, así como temas afines o vinculados a sus funciones. EL APRENDIZ acepta manejar toda esta información de manera confidencial siguiendo los lineamentos de todas cláusulas estipuladas en el presente convenio. </span>
           	</td>
        </tr>
    </table>
    <br>
    <table cellspacing="0" style="width: 100%; text-align: justify;  vertical-align: middle" >
        <tr>
		    <td>
           		<span style="line-height:15px;font-size: 10pt;">Encontrándose ambas partes conformes con el contenido del presente Acuerdo, proceden a suscribirlo en señal de ratificación y aceptación plena a los (<?php echo $diagen ?>) días del mes de <?php echo $mesg ?> del <?php echo $aniogen ?></span>
	...
	<table cellspacing="0" style="width: 100%; text-align: right;  vertical-align: middle" >
        <tr>
        	<td style="width: 30%; color: black;font-size:12px;text-align:center;font-weight:bold;">
                <span>EL APRENDIZ</span>
            </td>
			<td style="width: 30%; color: #444444;">
            </td>
...
<page backtop="15mm" backbottom="15mm" backleft="17mm" backright="15mm" style="font-size: 11pt; font-family: arial" >
	...
	<table cellspacing="0" style="width: 100%; text-align: justify;  vertical-align: middle" >
        <tr>
		    ...
		    <td>
           		<span style="font-size:12px;font-weight:bold;">Cargo: <?php echo $especialidad_convenio ?></span>
           	</td>
...
<!--COMRPOMISO DE ENTREGA DE DOCUMENTOS-->
<page backtop="15mm" backbottom="15mm" backleft="17mm" backright="15mm" style="font-size: 11pt; font-family: arial" >
    <table cellspacing="0" style="width: 100%;">
        <tr>
            <td style="width: 25%; color: black;font-size:15px;text-align:middle">
                
            </td>
			<td style="width: 65%; color: #444444;">
                <span style="color: black;font-size:15px;font-weight:bold; text-decoration: underline;">COMPROMISO DE ENTREGA DE DOCUMENTOS</span>
            </td>
			<td style="width: 25%;text-align:right">
    ...
    <table cellspacing="0" style="width: 100%; text-align: justify;  vertical-align: middle" >
        <tr>
		    <td>
           		<span style="line-height:15px;font-size: 10pt;">Yo, <?php echo $nom_postu ?></span>
    ...
    <table cellspacing="0" style="width: 100%; text-align: justify;  vertical-align: middle" >
        <tr>
		    <td>
           		<span style="line-height:15px;font-size: 10pt;">Identificado con <?php echo $tipo_documento ?> Nro. <?php echo $dni_postulante ?>, postulante para el Programa Formativo Laboral de Aprendizaje con Predominio en la empresa, en la empresa TAI LOY S.A.</span>
           	</td>
        </tr>
    </table>
    <br>
    <table cellspacing="0" style="width: 100%; text-align: justify;  vertical-align: middle" >
        <tr>
		    <td>
           		<span style="line-height:15px;font-size: 9pt;font-weight:bold;">ME COMPROMETO BAJO JURAMENTO A: </span>
    ...
    <table cellspacing="0" style="width: 100%; text-align: justify;  vertical-align: middle" >
        <tr>
		    <td>
           		<span style="line-height:15px;font-size: 10pt;">Que, los documentos que a continuación se mencionan se encuentran pendientes de entrega por mi parte; por lo que me comprometo a entregarlos a la empresa TAI LOY S.A. (<?php echo $area_postu ?>) en un plazo no mayor a siete (7) días naturales contados desde el inicio del Programa Formativo Laboral de Aprendizaje con Predominio en la empresa.</span>
           	</td>
        </tr>
    </table>
    <br>
    <table cellspacing="0" style="width: 100%; text-align: justify;  vertical-align: middle" >
        <tr>
		    <td>
           		<span style="line-height:15px;font-size: 10pt;">Asimismo, autorizo a la empresa patrocinante a descontar la suma de S/. 10.50 de la subvención mensual que perciba, por corresponder al costo del trámite correspondiente a certificado de antecedentes policiales, penales, judiciales; entre otros, que he solicitado como préstamo voluntariamente a la empresa, por ser de mi interés.</span>
           	</td>
        </tr>
    </table>
    <br>
    <table cellspacing="0" style="width: 100%; text-align: justify;  vertical-align: middle" >
        <tr>
		    <td>
           		<span style="line-height:15px;font-size: 10pt;">Por lo expuesto, en el plazo señalado en el primer párrafo de este documento, haré entrega a la empresa TAI LOY (TIENDA ASIGNADA) de los siguientes documentos:</span>
           	</td>
        </tr>
    </table>
    <br>
    <table cellspacing="0" style="width: 100%; text-align: justify;  vertical-align: middle" >
        <tr>
		    <td>
           		<span style="line-height:15px;font-size: 10pt;">___ 1 Fotocopia simple del Certificado de Estudios (Colegio primaria o secundaria). <br>___ Una (01) fotografía, con fondo blanco.</span>
           	</td>
        </tr>
    </table>
    <br>
    <table cellspacing="0" style="width: 100%; text-align: justify;  vertical-align: middle" >
        <tr>
		    <td>
           		<span style="line-height:15px;font-size: 10pt;">Dichos documentos son indispensables para el inicio e inscripción del Convenio de Aprendizaje con Predominio en la empresa ante el Ministerio de Trabajo y Promoción del Empleo, por tanto, de no cumplir con la entrega de los documentos mi Convenio no podrá ser presentado ante la autoridad de trabajo y por tanto quedará anulado, no pudiendo continuar con mi Programa Formativo Laboral en la empresa, procediendo a retirarme de manera voluntaria inmediatamente.</span>
           	</td>
        </tr>
    </table>
    <br>
    ...
    $queryReferencia = "SELECT 
		...
		//echo $conexion;
		while($registroReferencia=odbc_fetch_array($resultReferencia)) {
			$nivel_secundaria=$registroReferencia['Co_Nivel_Educativo_Resumen'];
			$nombre_institucion_secundaria=$registroReferencia['De_Institiucion'];
			$ingreso_secundaria=$registroReferencia['Anno_Ingreso'];
			$egreso_secundaria=$registroReferencia['Anno_Egreso'];
		}
    ?>
    <table cellspacing="0" style="width: 100%; text-align: justify;  vertical-align: middle" >
        <tr>
		    <td>
           		<span style="line-height:15px;font-size: 10pt;">Finalmente, declaro bajo juramento que he cursado estudios (señalar si son primaros o secundarios) en el Centro Educativo <?php echo $nivel_secundaria ?> - <?php echo $nombre_institucion_secundaria ?> durante los años <?php echo $ingreso_secundaria ?> a <?php echo $egreso_secundaria ?>, por lo que, entregaré el respectivo Certificado de Estudios, conforme al compromiso señalado en esta carta.</span>
           		<!--.$niv_secu.' - '.$insti_secu.' durante los años '.$ingre_secu.' a '.$egre_secu.'-->
           	</td>
        </tr>
    </table><br>
     <table cellspacing="0" style="width: 100%; text-align: justify;  vertical-align: middle" >
        <tr>
		    <td>
           		<span style="line-height:15px;font-size: 10pt;">Atentamente,</span>
           		<!--.$niv_secu.' - '.$insti_secu.' durante los años '.$ingre_secu.' a '.$egre_secu.'-->
           	</td>
        </tr>
    </table>
...
<page backtop="20mm" backbottom="20mm" backleft="20mm" backright="20mm" style="font-size: 12pt; font-family: arial" >
    ...
    <table cellspacing="0" style="width: 100%;">
        <tr>
            <td style="width: 35%; color: black;font-size:15px;text-align:justify">
                <img src='../../images/icon/manos_dinamicas.png' style='    max-width: 70px;
				    height: 50px;
				    float: left;'  />
            </td>
			<td style="width: 60%; color: #444444;">
                <span style="color: black;font-size:15px;font-weight:bold;text-decoration: underline black;">FICHA DE MATRÍCULA</span>
            </td>
			<td style="width: 20%;text-align:right">
    ...
    <table cellspacing="0" style="width: 100%;font-size: 9pt;">
    	<tr style="text-align: left; ">
			<td style="font-size: 9pt;width: 30%;">APELLIDO PATERNO*</td>
			<td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000;width: 70%; height: 15px;font-size: 9pt;"> &nbsp;<?php echo $apellido_paterno_postu ?></td>
		</tr>
    ...
    <table cellspacing="0" style="width: 100%;font-size: 9pt;">
    	<tr style="text-align: left; ">
			<td style="font-size: 9pt;width: 30%;">APELLIDO MATERNO*</td>
			<td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000;width: 70%; height: 15px;font-size: 9pt;"> &nbsp;<?php echo $apellido_materno_postu ?></td>
		</tr>
    ...
    <table cellspacing="0" style="width: 100%;font-size: 9pt;">
    	<tr style="text-align: left; ">
			<td style="font-size: 9pt;width: 30%;">NOMBRES*</td>
			<td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000;width: 70%; height: 15px;font-size: 9pt;"> &nbsp;<?php echo $nom_postu ?></td>
		</tr>
    ...
    <table cellspacing="0" style="width: 100%;font-size: 9pt;">
    	<tr style="text-align: left; ">
			<td style="font-size: 9pt;width: 30%;">FECHA DE NACIMIENTO*</td>
			<td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000;width: 20%; height: 15px;font-size: 9pt;"> &nbsp;<?php echo $fecha_nacimiento_postu ?></td>
			<td style="font-size: 9pt;width: 30%;">DNI*</td>
			<td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000;width: 20%; height: 15px;font-size: 9pt;"> &nbsp;<?php echo $dni_postulante ?></td>
		</tr>
    ...
    <table cellspacing="0" style="width: 100%;font-size: 9pt;">
    	<tr style="text-align: left; ">
			<td style="font-size: 9pt;width: 30%;">DIRECCIÓN CASA*</td>
			<td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000;width: 70%; height: 15px;font-size: 9pt;"> &nbsp;<?php echo $direccion_postu ?></td>
		</tr>
    ...
    <table cellspacing="0" style="width: 100%;font-size: 9pt;">
    	<tr style="text-align: left; ">
			<td style="font-size: 9pt;width: 30%;">URBANIZACIÓN*</td>
			<td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000;width: 20%; height: 15px;font-size: 9pt;"> &nbsp;<?php echo $des_zona ?></td>
			<td style="font-size: 9pt;width: 30%;">DISTRITO*</td>
			<td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000;width: 20%; height: 15px;font-size: 9pt;"> &nbsp;<?php echo $nombre_distrito_postu ?></td>
		</tr>
    ...
    <table cellspacing="0" style="width: 100%;font-size: 9pt;">
    	<tr style="text-align: left; ">
			<td style="font-size: 9pt;width: 30%;">TEL. FIJO*</td>
			<td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000;width: 20%; height: 15px;font-size: 9pt;"> &nbsp;<?php echo $fijo_postu ?></td>
			<td style="font-size: 9pt;width: 30%;">CELULAR*</td>
			<td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000;width: 20%; height: 15px;font-size: 9pt;"> &nbsp;<?php echo $celular_postu ?></td>
		</tr>
    ...
    <table cellspacing="0" style="width: 100%;font-size: 9pt;">
    	<tr style="text-align: left; ">
			<td style="font-size: 9pt;width: 30%;">E-MAIL PERSONAL*</td>
			<td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000;width: 70%; height: 15px;font-size: 9pt;"> &nbsp;<?php echo $correo_postu ?></td>
		</tr>
    ...
    <table cellspacing="0" style="width: 100%;font-size: 9pt;">
    	<tr style="text-align: left; ">
			<td style="font-size: 9pt;width: 30%;">LOCAL DE ESTUDIO*</td>
			<td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000;width: 70%; height: 15px;font-size: 9pt;"> &nbsp;</td>
		</tr>
    ...
    <table cellspacing="0" style="width: 100%;font-size: 9pt;">
    	<tr style="text-align: left; ">
			...
			<td style="width: 70%; height: 15px;font-size: 9pt; font-weight:bold;"> PARA SER LLENADO POR EL CETPROP TECNOLOGIA CENTRALIZADA</td>
		</tr>
    ...
    <table cellspacing="0" style="width: 100%;font-size: 9pt;">
    	<tr style="text-align: left; ">
			<td style="font-size: 9pt;width: 30%;">ESPECIALIDAD</td>
			<td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000;width: 70%; height: 15px;font-size: 9pt;"> &nbsp;<?php echo $especialidad_convenio ?></td>
		</tr>
    ...
    <table cellspacing="0" style="width: 100%;font-size: 9pt;">
    	<tr style="text-align: left; ">
			<td style="font-size: 9pt;width: 30%;text-decoration: underline black;font-weight:bold">INFORMACIÓN DE LA EMPRESA</td>
			<td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000;width: 70%; height: 15px;font-size: 9pt;"> &nbsp;<?php echo $des_emp ?></td>
		</tr>
    ...
    <table cellspacing="0" style="width: 100%;font-size: 9pt;">
    	<tr style="text-align: left; ">
			<td style="font-size: 9pt;width: 30%;">RUC NRO.</td>
			<td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000;width: 70%; height: 15px;font-size: 9pt;"> &nbsp;<?php echo $numero_ruc ?></td>
		</tr>
    ...
    <table cellspacing="0" style="width: 100%;font-size: 9pt;">
    	<tr style="text-align: left; ">
			<td style="font-size: 9pt;width: 30%;">TELF.</td>
			<td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000;width: 70%; height: 15px;font-size: 9pt;"></td>
		</tr>
    ...
    <table cellspacing="0" style="width: 100%;font-size: 9pt;">
    	<tr style="text-align: left; ">
			<td style="font-size: 9pt;width: 30%;">DIRECCIÓN</td>
			<td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000;width: 70%; height: 15px;font-size: 9pt;">JR. MARIANO ODICIO NRO. 153 URB. MIRAFLORES</td>
		</tr>
    ...
    <table cellspacing="0" style="width: 100%;font-size: 9pt;">
    	<tr style="text-align: left; ">
			<td style="font-size: 9pt;width: 30%;">DISTRITO</td>
			<td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000;width: 70%; height: 15px;font-size: 9pt;">SURQUILLO</td>
		</tr>
    ...
    <table cellspacing="0" style="width: 100%;font-size: 9pt;">
    	<tr style="text-align: left; ">
			<td style="font-size: 9pt;width: 30%;">ACTIVIDAD DE LA EMPRESA</td>
			<td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000;width: 70%; height: 15px;font-size: 9pt;">	VENTA AL POR MAYOR NO ESPECIALIZADA</td>
		</tr>
    ...
    <table cellspacing="0" style="width: 100%;font-size: 9pt;">
    	<tr style="text-align: left; ">
			<td style="font-size: 9pt;width: 30%;">OCUPACIÓN A DESARROLLAR</td>
			<td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000;width: 70%; height: 15px;font-size: 9pt;"><?php echo $ocupacion_convenio ?></td>
		</tr>
    ...
    <table cellspacing="0" style="width: 100%;font-size: 9pt;">
    	<tr style="text-align: left; ">
			<td style="font-size: 9pt;width: 30%;">FECHA DE INICIO</td>
			<td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000;width: 30%; height: 15px;font-size: 9pt;"><?php echo $fecha_ingreso_numero ?></td>
		</tr>
    ...
    <table cellspacing="0" style="width: 100%;font-size: 9pt;">
    	<tr style="text-align: left; ">
			<td style="font-size: 9pt;width: 70%;text-decoration: underline black;font-weight:bold"></td>
			<td style="width: 30%; height: 20px;font-size: 9pt;">_______________________</td>
		</tr>
    ...
    <table cellspacing="0" style="width: 100%;font-size: 9pt;">
    	<tr style="text-align: left; ">
			<td style="font-size: 9pt;width: 70%;text-decoration: underline black;font-weight:bold"></td>
			<td style="width: 30%; height: 20px;font-size: 9pt;">FIRMA DEL APRENDIZ</td>
		</tr>
